...
// const znajdzHaslo = () => {
//     if(haslo.value === 'MAŁYSZ'){
//         document.querySelector('.j_1').innerText = 'M';
//         document.querySelector('.j_2').innerText = 'A';
//         document.querySelector('.j_3').innerText = 'Ł';
//         document.querySelector('.j_4').innerText = 'Y';
//         document.querySelector('.j_5').innerText = 'S';
//         document.querySelector('.j_6').innerText = 'Z';
...
// const uzupelnijPiatyWiersz = () =>{
//     document.querySelector('.5_1').innerHTML = 'B';
//     document.querySelector('.5_2').innerHTML = 'E';
//     document.querySelector('.5_3').innerHTML = 'S';
//     document.querySelector('.5_4').innerHTML = 'T';
//     document.querySelector('.5_5').innerHTML = 'I';
//     document.querySelector('.5_6').innerHTML = 'A';
// }

// const uzupelnijSzostyWiersz = () =>{
...
//     document.querySelector('.s_5').innerHTML = 'A';
//     document.querySelector('.s_6').innerHTML = 'T';
// }

// const uzupelnijHaslo = () => {
    
//     if(haslo.value === 'MAŁYSZ'){uzupelnijPierwszyWiersz}
//     // if(haslo === 'STUDENT'){uzupelnijDrugiWiersz}
